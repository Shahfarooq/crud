...
app.use(
    ...
    connection(mysql,{
        ...
        password : '',
        database : 'nodejs',
        debug    : false //set true if you want to see debug logger
    },'request')

);

app.get('/',function(req,res){
    res.send('Welcome, go to /api/user');
});
...
*  for every route starting with /api
--------------------------------------------------------*/
...
curut.get(function(req,res,next){
    ...
    req.getConnection(function(err,conn){
        ...
        var query = conn.query('SELECT * FROM t_user',function(err,rows){
            ...
            res.render('user',{title:"CRUD App",data:rows});
...
curut2.all(function(req,res,next){
    console.log("additions to curut 2 parameter");
